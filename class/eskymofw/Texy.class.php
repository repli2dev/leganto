...
new
RuntimeException("Texy cannot run with zend.ze1_compatibility_mode enabled.");}if(!class_exists('ObjectForTexy',FALSE)){abstract
class
ObjectForTexy{final
public
function
...
TexyModifier
extends
ObjectForTexy{public$id;public$classes=array();public$styles=array();public$attrs=array();public$hAlign;public$vAlign;public$title;public$cite;public
...
TexyModule
extends
ObjectForTexy{protected$texy;}class
TexyParser
extends
ObjectForTexy{protected$texy;protected$element;public$patterns;public
function
...
extends
ObjectForTexy{private$handlers;private$pos;private$args;private$parser;public
function
...
TexyImage
extends
ObjectForTexy{public$URL;public$overURL;public$linkedURL;public$width;public$height;public$asMax;public$modifier;public$name;public
function
