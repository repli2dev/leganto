...
*/
abstract class MySQLTableCompetition {
	...
	*/
	public static $importantColumns = array("name","content","expiration", "user");
        ...
        */
        protected static function getCommonItems() {
                return "
                	...
                	".self::getTableName().".content AS content,
                	".self::getTableName().".date AS date,
                	".self::getTableName().".expiration AS expiration,
